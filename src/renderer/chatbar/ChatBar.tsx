    ...
    <div className="w-full h-full flex flex-col tp-surface p-1.5 pb-3">
      ...
      >
        ...
        <form ref={formRef} onSubmit={handleSubmit} className="flex items-center gap-3 px-3 pb-3 pt-1">
          ...
          {/* Screenshot button — outlined chip, teal utility icon */}
          <button
            type="button"
          ...
          >
            {isCapturing ? (
              <div className="w-4 h-4 border-2 border-[var(--tp-coral)] border-t-transparent rounded-full animate-spin" />
            ) : (
              <Icon icon="solar:camera-linear" className="text-lg" />
            )}
          </button>

          {/* Mic button — outlined chip; solid coral while recording (acting) */}
          <button
            type="button"
